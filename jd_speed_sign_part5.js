/*
cron "5 16 * * *" jd_speed_sign_part5.js, tag:京东极速版任务5
*/
...
!(async () => {
    ...
    let lnTotalAcc=Math.ceil(cookiesArr.length/5)*5;
...
function invite() {
    let t = +new Date()
    let inviterId = ["p/55JnY60VWDj6bH/M5q+g==","Pj9iMhQpano09pcHF/OGCw=="][Math.floor((Math.random() * 2))]
    var headers = {
        'Host': 'api.m.jd.com',
